    ...
    fun MenuPrincipal(){
        ...
        Box(
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
                Image(painterResource(id = R.drawable.sports_logofootball_logo_game_logo_socccer___hecho_con_postermywall),
                ...
                Row(Modifier.padding(0.dp, 0.dp, 0.dp, 40.dp)) {
                    Column {
                        TextField(value = contraseña
                            ...
                            ,leadingIcon = {
                                Icon(painterResource(id = R.drawable.ic_action_lock_closed), contentDescription = null)
                            }
                            ,colors = TextFieldDefaults.textFieldColors(
